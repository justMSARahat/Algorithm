//Merge Sort amar favorite karon eta ekta smart algorithm jeita divide and conquer technique use kore. Eta array ke chhoto chhoto part e vag kore easily sort kore, then nicely merge kore result dey. Eita always O(n log n) time e kaj kore, tai onno sorting gula theke fast and consistent. Mid term er jonno eta bujha easy, likha easy, mark paoya sure!
...
void margesort(int arr[], int left, int right)
{
    ...
    cout << "Marge Sort Algorithm: " << endl for (int i = 0; i < right + 1; i++)
    {
        cout << arr[i];
        if (i < right - 1)
            cout << " ";
